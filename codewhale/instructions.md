...
* **Follow the 50/72 rule**: Keep the summary line at most 50 characters. Wrap the body (if any) at 72 characters. Separate summary and body with a blank line.
...
## Project Architecture (Reference: `~/Projects/`)
